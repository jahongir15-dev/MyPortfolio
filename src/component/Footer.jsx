                    ...
                    <div className="row mb-5">
                        ...
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4 ml-md-4">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Services</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Projects</a>
                                    </li>
                        ...
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4">
                                ...
                                <ul className="list-unstyled">
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Web Design</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Web Development</a>
                                    </li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Business
                                        Strategy</a></li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Data
                                        Analysis</a></li>
                                    <li><a href="#"><span className="icon-long-arrow-right mr-2"/>Graphic
                                        Design</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="ftco-footer-widget mb-4">
                                ...
                                <div className="block-23 mb-3">
                                    <ul>
                                        ...
                                        <li><a href="#"><span className="icon icon-phone"/><span className="text">+2 392 3929 210</span></a>
                                        </li>
